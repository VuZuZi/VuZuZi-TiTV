package TITV_learning.Code.bai86_ThanhCuon.view;

import TITV_learning.Code.bai86_ThanhCuon.controller.TimKiemListener;
import TITV_learning.Code.bai86_ThanhCuon.model.TimKiemModel;
...
public class TimKiemView extends JFrame {
    ...
    private void init() {
        ...
        JScrollPane jScrollPane = new JScrollPane(textArea,JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
